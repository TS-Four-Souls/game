...
describe("Treasure - \"Each time a player rolls a\" effect", () => {
    ...
    it("charged_baby", async () => {
        ...
        const recharged = (await game.select(player1, 0, 1, inplayUnchargedItemSelector(game)(player1), {key:""}, "death")).selected[0] as Card;
    ...
    it("the_d10", async () => {
        ...
        const foundTopCard = game.encounters._slots[1]![1] === topMonsterCard;
        ...
        const foundNewTopCard = game.encounters._slots[1]![2] === topMonsterCard2
