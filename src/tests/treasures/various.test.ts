...
describe("Treasure - Passive effects", () => {
    ...
    it("steamy_sale - shop items cost 5¢ less", async () => {
        ...
        game.entityHandler.addPurchaseThisTurn(player1, 1); // allow purchase
        game.actions.declarePurchase(player1);
        game.actions.purchase(player1, 0); // index 0 is first shop slot
    ...
    it("steamy_sale - purchasing with exact coins", async () => {
        ...
        game.entityHandler.addPurchaseThisTurn(player1, 1); // allow purchase
        game.actions.declarePurchase(player1);
        const result = game.actions.purchase(player1, 1);
    ...
    it("sacred_heart - change roll of 1 to 6", async () => {
        ...
        const dice = game.rollDice(player1, sacredHeart);
        dice.value = 1;
    ...
    it("sacred_heart - choose not to change roll of 1", async () => {
        ...
        // Roll a dice and set it to 1
        const dice = player1.rollDice(Math.random, sacredHeart);
        dice.value = 1;
    ...
    it("theres_options - allows purchasing twice in one turn", async () => {
        ...
        game.actions.declarePurchase(player1);
        const result2 = game.actions.purchase(player1, 1);
